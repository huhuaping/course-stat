...
Vacation <- read.delim("C:/Users/denni_000/Desktop/STAT506 R/Vacation.txt") 
...
plot(Mi,yi,main="Scatter plot of Yi vs Mi",xlab="Cluster size",ylab="total for the cluster",pch=19)
