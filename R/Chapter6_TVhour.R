...
#On purpose,  the R code here is written in a straightforward way instead of in a sophisticated manner. 

TVhour<-read.delim("C:/Users/denni_000/Desktop/STAT506 R/TVhour.txt") 
...
d #because d=21.089, we round it down and set it as 21
dof=21
