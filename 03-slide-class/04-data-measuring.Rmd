...
$$\begin{align}
计划完成相对指标 &= \frac{实际为基数的百分数}{计划为基数的百分数}\times 100\% \\
&= \frac{1 \pm 实际增减百分数}{1  \pm 计划增减百分数}\times 100\% 
\end{align}$$
...
**示例计算1（正向指标情形）**：某车间5位工人的劳动生产率（.red[件/小时]）资料如下，请分别计算全部工人单位时间内的平均劳动生产率是多少？
...
**示例计算2（逆向指标指标情形）**：某车间5位工人的劳动生产率（.red[分钟/件]）资料如下，请分别计算全部工人单位时间内的平均劳动生产率是多少？
