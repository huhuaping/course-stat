...
.panelset[
.panel[.panel-name[a.柱状图]

根据饮料类型购买次数的分配数据表，我们可以绘制出如下**柱状图**：
...
.panel[.panel-name[b.条形图]

根据饮料类型购买次数的分配数据表，还可以绘制出如下**条形图**：
