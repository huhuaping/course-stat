...
**案例说明**：某企业生产三种不同的产品，报告期和基期的产量和出厂价格如下标所示。
...
&=\frac{\sum\limits_{i=1}^n\left(\boldsymbol{k}_{q} \cdot \boldsymbol{f}_{00}\right)}{\sum\limits_{i=1}^n f_{00}} 
\\
&=A_{q(L)} 
\end{aligned}$$
]
...
&=\frac{\sum\limits_{i=1}^n\left(\boldsymbol{k}_{p} \cdot \boldsymbol{f}_{00}\right)}{\sum\limits_{i=1}^n f_{00}} 
\\
&=A_{p(L)} 
\end{aligned}$$
...
.pull-left[
$$\begin{aligned}
\boldsymbol{I}_{\boldsymbol{q(P)}}  &=\frac{\sum\left(\boldsymbol{q}_{1} \boldsymbol{p}_{1}\right)}{\sum\left(\boldsymbol{q}_{0} \boldsymbol{p}_{1}\right)} \\
&=\frac{\sum\left[\left(\frac{\boldsymbol{q}_{1}}{\boldsymbol{q}_{\boldsymbol{0}}}\right) \cdot\left(\boldsymbol{q}_{0} \boldsymbol{q}_{1}\right)\right]}{\sum\left(\boldsymbol{q}_{0} \boldsymbol{p}_{1}\right)} \\
&=\frac{\sum\left(\boldsymbol{k}_{q} \cdot \boldsymbol{f}_{\text {01}}\right)}{\sum \boldsymbol{f}_{01}} \\
