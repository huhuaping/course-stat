...
p_sample_all<- p2 + 
  ...
  geom_text(aes(x=120,y=180),
             label=latex2exp::TeX("$SRL1 \\hat{Y}=17.81+0.62X_i$"), color="black",size=5)+
  geom_text(aes(x=120,y=170),
             label=latex2exp::TeX("$SRL2 \\hat{Y}=7.12+0.65X_i$"), color="purple",size=5) +
  geom_text(aes(x=120,y=160),
             label=latex2exp::TeX("$PRL \\hat{Y}=17+0.6X_i$"), color="red",size=5) 
