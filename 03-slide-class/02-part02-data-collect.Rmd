...
```{r}
knitr::include_graphics("../pic/chpt02-CFPS-application00.png", dpi = 150)
```
...
```{r}
knitr::include_graphics("../pic/chpt02-CFPS-application02.png", dpi = 100)
```
...
```{r}
knitr::include_graphics("../pic/chpt02-CFPS-application03.png", dpi = 120)
```
...
```{r}
knitr::include_graphics("../pic/chpt02-CHARLS-application00.png", dpi = 100)
```
...
```{r}
knitr::include_graphics("../pic/chpt02-CHARLS-application01.png", dpi = 100)
```
