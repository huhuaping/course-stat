...
```{r, out.height=550}
knitr::include_graphics("../pic/chpt02-data-clean-xian01.png")
```
...
```{r, out.height=350}
knitr::include_graphics("../pic/chpt02-data-clean-xian02.png")
```
...
```{r, out.height=550}
knitr::include_graphics("../pic/chpt02-data-clean-xian03.png")
```
